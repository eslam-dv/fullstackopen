...
function pt(e, n) {
  e.blockedOn === n &&
    ((e.blockedOn = null),
    ao ||
      ((ao = !0), ye.unstable_scheduleCallback(ye.unstable_NormalPriority, ef)))
}
function It(e) {
  function n(l) {
    return pt(l, e)
...
function Li(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null))
    Nr(e, n), Pa(n, t, r), xo(n, t, r, l), (r = !0)
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps
    u.props = i
...
function pe(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Yu(t), n === 1))
      e.tag === 0 ? Zf($i.bind(null, e)) : bs($i.bind(null, e)),
        Kf(function () {
          !(R & 6) && hn()
        }),
        (t = null)
...
var Ld = ns.exports,
  tc,
  Hi = Ld
;(tc = Hi.createRoot), Hi.hydrateRoot
const Mu = 'http://localhost:3001/api/notes'
async function Rd() {
  return fetch(Mu).then((e) => e.json())
}
async function Od(e) {
  return await (
    await fetch(Mu, {
...
const Ql = { getAll: Rd, create: Od, update: Md },
  jd = ({ note: e, toggleImportance: n }) => {
    const t = e.important ? 'make not important' : 'make important'
    return G.jsxs('li', {
      className: 'note',
      children: [e.content, ' ', G.jsx('button', { onClick: n, children: t })],
    })
  },
  Dd = ({ message: e }) =>
    e === null ? null : G.jsx('div', { className: 'error', children: e }),
  Id = () => {
  ...
  Fd = () => {
    ...
    const s = (p) => {
      ...
      h = (p) => {
        const g = e.find((S) => S.id === p),
          w = { ...g, important: !g.important }
        Ql.update(p, w)
          .then((S) => {
            n(e.map((O) => (O.id !== p ? O : S)))
          })
          .catch((S) => {
            i(`Note '${g.content}' was already removed from server`),
              setTimeout(() => {
                i(null)
              }, 5e3),
              n(e.filter((O) => O.id !== p))
      ...
      m = l ? e : e.filter((p) => p.important)
    return G.jsxs('div', {
      children: [
        G.jsx('h1', { children: 'Notes' }),
        G.jsx(Dd, { message: u }),
        G.jsx('div', {
        ...
        G.jsx('ul', {
          children: m.map((p) =>
            G.jsx(jd, { note: p, toggleImportance: () => h(p.id) }, p.id),
          ),
        }),
        G.jsxs('form', {
          onSubmit: s,
          children: [
            G.jsx('input', { value: t, onChange: c }),
            G.jsx('button', { type: 'submit', children: 'save' }),
          ],
        }),
        G.jsx(Id, {}),
      ],
...
tc(document.getElementById('root')).render(G.jsx(Fd, {}))
